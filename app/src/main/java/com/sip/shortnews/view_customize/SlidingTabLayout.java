...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public void setOnclickMenu(OnClickListener onClickListener){
        mOnclickMenuListener = onClickListener;
    }
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if(i==0) {
                ...
                tabView = LayoutInflater.from(getContext()).inflate(R.layout.custom_tab_view2, mTabStrip,
                        false);
                tabTitleView = (TextView) tabView.findViewById(textId);
                mLnTabRight = (RelativeLayout) tabView.findViewById(R.id.tab_child);
                mLnTabRight.setBackgroundColor(Color.parseColor("#0C404F"));
            }
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int position) {
            if(position == 0){
                ...
                mLnTabRight.setBackgroundColor(Color.parseColor("#377B8F"));
                mLnTabLeft.setBackgroundColor(Color.parseColor("#0C404F"));
            }
